package com.frogniche.legendfoxes.server.block;
...
public class LFBlockHandler {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, LegendFoxes.MOD_ID);

    public static final RegistryObject<Block> DEVOURER_SPORE = registerBlock("devourer_spore",
            () -> new SlimeBlock(BlockBehaviour.Properties.of(Material.CLAY,
                    MaterialColor.GRASS).friction(0.8F).sound(SoundType.SLIME_BLOCK)));
    ...
    private static <T extends Block> RegistryObject<Item> registerBlockItem(String name, RegistryObject<T> block) {
        return LFItemHandler.ITEMS.register(name, () -> new BlockItem(block.get(),
                new Item.Properties()));
    }
